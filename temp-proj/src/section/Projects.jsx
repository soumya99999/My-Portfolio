...
import { Suspense, useState, lazy, useCallback, useMemo } from 'react';
...
const Projects = () => {
    ...
    useGSAP(() => {
        ...
        tl.fromTo('.animatedText', { opacity: 0 }, { opacity: 1, duration: 1, stagger: 0.2, ease: 'power2.inOut' });
    }, [selectedProjectIndex]);

    const isMobile = useMediaQuery({ maxWidth: 768 });
    const scale = useMemo(() => (isMobile ? 1.4 : 1.7), [isMobile]);
                    ...
                    <Canvas>
                        ...
                        <Center>
                            <Suspense fallback={<CanvasLoader />}>
                                <group scale={scale} position={[0, -2, 0]} rotation={[0, -0.1, 0]}>
