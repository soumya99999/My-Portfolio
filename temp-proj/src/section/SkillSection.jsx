            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                {activeSkill && (
                    <div className="mt-8 bg-gray-800 p-6 rounded-lg shadow-md">
                        <h3 className="text-2xl font-semibold mb-4 text-white">About {activeSkill}</h3>
                        <p className="text-gray-300">
                            Here you can add more detailed information about your experience with {activeSkill}. 
                            Discuss projects you've worked on, challenges you've overcome, or specific areas of expertise within this skill.
                        </p>
                    </div>
                )}
            </div>
